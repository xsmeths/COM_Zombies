...
public class Vault {
	...
	public boolean inGroup(World world, String name, String group) {
		if (enabled)
			return false;
		// @TODO
		// this.permission.playerInGroup(world.getName(),Bukkit.getOfflinePlayer(Bukkit.getPlayer(name).getUniqueId()),
		// group);
		return false;
	}
	...
	public void setGroup(World world, String name, String group) {
		if (enabled)
			;
		// @TODO
		// this.permission.playerAddGroup(world.getName(),Bukkit.getOfflinePlayer(Bukkit.getPlayer(name).getUniqueId()),
		// group);
	}
	...
	public String getMainGroup(Player player) {
		if (enabled) {
			...
			return "";
			// this.permission.getPlayerGroups(player)[i];
		}
		return "";
	}
	...
	public String getGroup(Player player, int group) {
		if (enabled)
			return "";
		// @TODO
		// this.permission.getPlayerGroups(player)[group];
		return "";
	}
	...
	public int amountOfGroups(Player player) {
		if (enabled)
			return 0;
		// @TODO
		// this.permission.getPlayerGroups(player).length;
		return 0;
	}
	...
	public void removeGroup(World world, String name, String group) {
		if (enabled)
			;
		// @ TODO
		// this.permission.playerRemoveGroup(world.getName(),
		// Bukkit.getOfflinePlayer(Bukkit.getPlayer(name).getUniqueId()), group);
	}
